...
?>">
<div id="header-animated" class="header-type-5-wrap header-action header-type-background-image">
    <div class="header-type-5-top-header top-header">
        ...
        <div class="mobile-collapse" id="collapse-mobile-top-header">
            <div class="header-type-5-container container">
                <div class="col-lg-6 col-md-6 col-xs-6 col-sm-12 additional-menu">
                ...
                <div class="col-lg-6 col-md-6 col-xs-6 col-sm-12 social-lang-block">
    ...
    <div class="header-type-5 main-header">
        <div class="container">
            <div class="header-logo-left-block">

                <div class="subscribe-btn">
                    <a href="<?php if ('' != wpblog_theme_option('subscribe_url')): ?>
                            <?php echo esc_html(wpblog_theme_option('subscribe_url')); ?>
                        <?php endif; ?>" target="_blank">Subscribe</a>
                </div>
...
<!--                        <img src="--><?php //echo $logo; ?><!--" alt="--><?php //bloginfo( 'name' ); ?><!--">-->
            ...
            <div class="header-logo-right-block header-buttons">
                <?php if (wpblog_theme_option('header_type_search_switch')) { ?>
                    <a href="#" data-toggle="modal" data-target=".hidden-search">Search</a>
                <?php } ?>
                <?php if (wpblog_theme_option('header_type_cart_switch')) { ?>
                    <?php if(class_exists('WooCommerce')): ?>
                        <a href="#" data-toggle="modal" data-target=".hidden-cart" class="top-cart-5">Cart
                ...
                <?php if (wpblog_theme_option('header_type_login_switch')) { ?>
                    <a href="#" data-toggle="modal" data-target=".hidden-login">Sign in</a>
                <?php } ?>
            </div>
        </div>
    </div>
    <div class="header-type-5 top-header">
    ...
    <div class="mobile-menu-wrap">
        <div class="container1">
            ...
            <div class="mobile-buttons-wrap">
                ...
                <div class="mobile-login"><a role="button" data-toggle="collapse" href="#collapseLogin" aria-expanded="false" aria-controls="collapseLogin"><i class="ggctrl-lock"></i></a></div>
            </div>
        </div>
    </div>
    ...
    <div class="collapse" id="collapseSearch">
        <div class="mobile-collapse-container header-search-collapse">
            ...
            <form role="search" method="get" id="searchform2" class="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                <div>
                    <label class="screen-reader-text" for="s"><?php _e( 'Search for:', 'wpblog-theme'); ?></label>
                    <input type="text" value="<?php echo esc_attr(get_search_query()); ?>" name="s" id="s2" />
                    <input type="submit" id="searchsubmit2" value="<?php echo esc_attr_e( 'Search', 'wpblog-theme'); ?>" />
                </div>
            </form>
        </div>
    </div>
