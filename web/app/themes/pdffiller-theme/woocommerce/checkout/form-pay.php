	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php _e( 'Qty', 'wpblog-theme' ); ?></th>
				<th class="product-total"><?php _e( 'Totals', 'wpblog-theme' ); ?></th>
			</tr>
		</thead>
		<tbody>
			...
			<ul class="wc_payment_methods payment_methods methods">
				<?php
					if ( ! empty( $available_gateways ) ) {
						...
						echo '<li>' . apply_filters( 'woocommerce_no_available_payment_methods_message', __( 'Sorry, it seems that there are no available payment methods for your location. Please contact us if you require assistance or wish to make alternate arrangements.', 'wpblog-theme' ) ) . '</li>';
					}
				?>
			</ul>
		<?php endif; ?>
