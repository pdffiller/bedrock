...
echo sprintf( __( "Hi there. Your recent order on %s has been completed. Your order details are shown below for your reference:", 'wpblog-theme' ), get_option( 'blogname' ) ) . "\n\n";
